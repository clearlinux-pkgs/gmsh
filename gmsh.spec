...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697577554
mkdir -p clr-build
pushd clr-build
...
CXXFLAGS="$CLEAR_INTERMEDIATE_CXXFLAGS -march=x86-64-v3 -m64 -Wl,-z,x86-64-v3"
FCFLAGS="$CLEAR_INTERMEDIATE_FCFLAGS -march=x86-64-v3 -m64 -Wl,-z,x86-64-v3"
FFLAGS="$CLEAR_INTERMEDIATE_FFLAGS -march=x86-64-v3 -m64"
...
/usr/lib64/openmpi/lib/python3.12/site-packages/gmsh.py
/usr/lib64/openmpi/lib/python3.12/site-packages/onelab.py
